...
public class Editor extends JFrame {
	...
	private void setListeners(){
		...
		mZoomIn.addActionListener(e->mTextArea.setFont(new Font("sansserif",Font.PLAIN,mFontSize += 10)));
		
		mZoomOut.addActionListener(e->mTextArea.setFont(new Font("sansserif",Font.PLAIN,mFontSize -= 10)));
